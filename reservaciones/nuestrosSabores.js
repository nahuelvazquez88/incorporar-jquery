...
class Cerveza {
    ...
    let resultadoInput=document.getElementById("resultadoInput")
     resultadoInput.innerHTML =`<p id="parrafo" class='cervezaSeleccionada'> La cerveza seleccionada es: ${cerveza.name}.El precio es: $${cerveza.precio}.</p> `
    }
    }
    }
    
    //jquery entregable 
    let cervezaSeleccionada =$(' .cervezaSeleccionada ') 
